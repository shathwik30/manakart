  ...
  if (reels.length === 0) {
    return (
      <div className="py-20 text-center">
        ...
        <h3 className="font-display text-2xl text-charcoal-900 mb-2">Coming Soon</h3>
        <p className="text-charcoal-600">New reels will be added shortly</p>
      </div>
    );
  }
  return (
          ...
          >
            <div className="relative aspect-[9/16] rounded-2xl overflow-hidden bg-gradient-to-br from-charcoal-900 to-charcoal-800 shadow-xl hover:shadow-2xl transition-all duration-500">
              ...
              {reel.outfit && (
                ...
                >
                  <Link href={`/outfit/${reel.outfit.slug}`} className="block">
                    <motion.div
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex-1 min-w-0 pr-2">
                          <p className="text-sm font-medium text-charcoal-900 truncate">{reel.outfit.title}</p>
                          <p className="text-xs text-gold-600">View Complete Outfit</p>
                        </div>
            ...
            {reel.title && (
              <motion.div
                ...
                className="mt-4 px-1"
              >
                <p className="text-sm font-medium text-cream-100 truncate">{reel.title}</p>
              </motion.div>
            )}
          </motion.div>
        );
