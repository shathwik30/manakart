  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-serif text-charcoal-900 mb-2">Products</h1>
          <p className="text-charcoal-500 text-sm">Manage your product inventory</p>
        </div>
        <Link
          href="/admin/products/new"
          className="flex items-center gap-2 bg-charcoal-900 text-cream-100 px-4 py-2 rounded hover:bg-charcoal-800 transition-colors"
        >
          <Plus size={18} />
        ...
        <div className="p-4 border-b border-charcoal-200 flex gap-4">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-cream-50 border border-charcoal-200 rounded focus:outline-none focus:border-gold-500"
            />
          </div>
        </div>
                  ...
                  <tr key={product.id} className="hover:bg-cream-50 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-16 bg-cream-50 relative rounded overflow-hidden flex-shrink-0">
                          {product.images?.[0] ? (
                            <Image
                        ...
                        <div>
                          <p className="font-medium text-charcoal-900">{product.title}</p>
                          <p className="text-xs text-charcoal-500 mt-0.5">{product.availableSizes.length} sizes</p>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <Link
                          ...
                          className="p-2 text-charcoal-600 hover:text-gold-500 hover:bg-cream-100 rounded transition-colors"
                        >
                          <Edit size={18} />
                        </Link>
                        <button
                          onClick={() => handleDelete(product.id)}
                          className="p-2 text-charcoal-600 hover:text-red-600 hover:bg-red-50 rounded transition-colors"
                        >
                          <Trash2 size={18} />
                        </button>
                      </div>
